...
// !set.has(k)
    ...
    for (var i=0; i<9; i++){
        ...
        if(sum!=45){
            console.log(sum);
            alert("Wrong Solution1");
            return;
        }
        else{
            for(var k=1; k<10; k++){
                if(!set.has(k)){
                    alert("Wrong Solution2", i);
                    return;   
                }
            }
        }
